...
<table width="547" height="294" border="0" align="center" cellpadding="0" cellspacing="0" background="image/20.jpg">
  <tr>
    <td width="125">&nbsp;</td>
    <td width="422" valign="bottom"><table width="411" border="0">
      <tr>
        <td width="66" height="38"><font color="#9A6634"><strong>用户名</strong></font>          </td>
        <td width="104"><input name="account" type="account" class="bgtext" size="15"></td>
        <td width="60">&nbsp;<font color="#9A6634"><strong>密码</strong></font>          </td>
        <td width="113"><input name="password" type="password" class="bgtext" size="15"></td>
        <td width="72"><div align="right">
          <input name="Submit" type="image" class="bgButtoninput" value="登陆" >
        </div></td>
      </tr>
      <tr>
